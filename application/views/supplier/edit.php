                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('no_telp', $supplier['no_telp']); ?>" name="no_telp" id="no_telp" type="text" class="form-control" placeholder="Masukkan nomor telepon...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('tempat', $supplier['tempat']); ?>" name="tempat" id="tempat" type="text" class="form-control" placeholder="Masukkan lokasi...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('mailing', $supplier['mailing']); ?>" name="mailing" id="mailing" type="text" class="form-control" placeholder="Masukkan e-mail...">
                        </div>
