        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                        ...
                        <div class="input-group">
                            <select name="barang_id" id="barang_id" class="custom-select">
                                ...
                                <?php foreach ($barang as $b) : ?>
                                    <option <?= set_value('barang_id', $barangmasuk['barang_id']) == $b['id_barang'] ? "selected" : ""  ?> value="<?= $b['id_barang'] ?>"><?= $b['id_barang'] . ' | ' . $b['nama_barang'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="input-group-append">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <input readonly="readonly" id="total_stok" type="number" value="<?= $stok['stok'] + set_value('jumlah_masuk', $barangmasuk['jumlah_masuk']) ?>" class="form-control">
                    </div>
                </div>
                <div class="row form-group">
