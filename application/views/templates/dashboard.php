...
<head>
    ...
    <title>Aplikasi Stok Barang | CV.Rehobot Emas Makmur </title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-black sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('harga'); ?>">Harga Barang</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-dark bg-black topbar mb-4 static-top shadow-sm">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            // Memeriksa apakah $barang_stok adalah array sebelum menggunakan count()
                            $notificationShown = false;

                            // Cek apakah $barang_stok adalah array dan tidak kosong
                            if (!empty($barang_stok) && is_array($barang_stok)) {
                                foreach ($barang_stok as $barang) {
                                    if ($barang->stok <= 3) {
                                        $notificationShown = true;
                                        break; // Hentikan loop jika ada barang yang stoknya kurang dari 3
                                    }
                                }
                            }
                            ...
                            if ($notificationShown) : ?>
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="fa fa-exclamation-circle" aria-hidden="true" style="color: #Bd0505;"><i class="fas fa-bell fa-lg fa-fw mr-2 text-gray-400"></i></i>
                                </a>
                                <!-- Dropdown - User Information -->
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                    <a class="dropdown-item" href="<?= base_url('barangminim'); ?>">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="http://localhost/invento1611/assets/img/Admin.png">
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table.container().appendTo('#dataTable_wrapper .col-md-5:eq(0)');
        });
    </script>
    <script type="text/javascript">
