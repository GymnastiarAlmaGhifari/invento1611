          ...
          <div class="card-body">
              ...
              <div class="row form-group">
                        ...
                        <div class="input-group">
                            <select name="barang_id" id="barang_id" class="custom-select">
                                ...
                                <?php foreach ($barang as $b) : ?>
                                    <option <?= set_value('barang_id', $barangkeluar['barang_id']) == $b['id_barang'] ? "selected" : ""  ?> value="<?= $b['id_barang'] ?>"><?= $b['id_barang'] . ' | ' . $b['nama_barang'] ?></option>
                                <?php endforeach; ?>
                            </select>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <input readonly="readonly" id="stok" type="number" value="<?= $stok['stok'] ?>" class="form-control">
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <input value="<?= set_value('jumlah_keluar', $barangkeluar['jumlah_keluar']); ?>" name="jumlah_keluar" id="jumlah_keluar" type="number" class="form-control" placeholder="Jumlah Keluar...">
                            <div class="input-group-append">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <input readonly="readonly" id="total_stok" type="number" value="<?= $stok['stok'] - set_value('jumlah_keluar', $barangkeluar['jumlah_keluar']) ?>" class="form-control">
                    </div>
                </div>
                    <div class="row form-group">
